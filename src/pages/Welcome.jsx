    ...
    return (
        <div className="flex flex-col min-h-screen bg-white">
            ...
            <section id="home" className="flex items-center justify-center min-h-screen px-4">
                <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-20">
                    <div className="flex flex-col mt-24">
                        <img 
                            src={IMAGES.WELCOME} 
                            alt="Welcome Text" 
                            className="w-full lg:w-[1000px] mb-2 lg:mb-6"
                        />
                        <p className="text-lg sm:text-xl lg:text-3xl text-gray-600 font-inter w-full lg:w-[1000px] h-auto lg:h-[72px] mt-16 text-center mx-auto">
                    ...
                    <div className="-mt-20 relative">
                        ...
                        <img 
                            src={IMAGES.ME}
                            alt="Welcome" 
                            className="relative z-10 w-[300px] h-[300px] lg:w-[502px] lg:h-[502px] rounded-full object-cover cursor-pointer transition-transform hover:scale-105"
                ...
                <div className="flex flex-col items-center max-w-6xl mx-auto w-full">
                    <picture>
                        ...
                        <img 
                            ...
                            alt="Dreams" 
                            className="w-full max-w-[1000px] h-auto object-contain mb-6"
                        />
                    </picture>
                    <div>
                        <Link 
